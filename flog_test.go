...
func ExampleNewLog() {
	...
	created := time.Now()
	fmt.Println(NewLog(&Option{Format: "apache_common"}, created))
	fmt.Println(NewLog(&Option{Format: "apache_combined"}, created))
	fmt.Println(NewLog(&Option{Format: "apache_error"}, created))
	fmt.Println(NewLog(&Option{Format: "rfc3164"}, created))
	fmt.Println(NewLog(&Option{Format: "rfc5424"}, created))
	fmt.Println(NewLog(&Option{Format: "common_log"}, created))
	fmt.Println(NewLog(&Option{Format: "unknown"}, created))
	fmt.Println(NewLog(&Option{Format: "json"}, created))
	// Output:
